// JadeAI utility functions for template rendering
// Adapted from JadeAI's src/components/preview/utils.ts

import type { ResumeSection, SummaryContent, SkillsContent } from './resume-types';
